...
cat <<EOF > $nnetdir/configs/network.xconfig.old
  ...
  # am part
  relu-batchnorm-layer name=tdnn3_am dim=512 input=Append(tdnn2@-3,tdnn2@0,tdnn2@3)
  ...
  # xvector part
  relu-batchnorm-layer name=tdnn3_xvec dim=512 input=Append(tdnn2@-3,tdnn2@0,tdnn2@3)
