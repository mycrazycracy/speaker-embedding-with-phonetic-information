...
valid_feats="ark,s,cs:copy-feats scp:$valid/feats.scp ark:- |"
train_subset_feats="ark,s,cs:utils/filter_scp.pl $dir/train_subset_uttlist $train/feats.scp | copy-feats scp:- ark:- |"
