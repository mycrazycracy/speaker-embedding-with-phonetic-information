...
cat <<EOF > $nnetdir/configs/network.xconfig.old
  ...
  # am part
  relu-batchnorm-layer name=tdnn2_am dim=512 input=Append(tdnn1@-2,tdnn1@0,tdnn1@2)
  ...
  # xvector part
  relu-batchnorm-layer name=tdnn2_xvec dim=512 input=Append(tdnn1@-2,tdnn1@0,tdnn1@2)
