...
def train(args, run_opts):
    ...
    # am_num_archives is no longer the reference for iteration, use xvec_num_archives instead. 
    am_num_archives = int(common_lib.get_command_stdout("cat {0}/info/num_archives".format(am_egs_dir)))
    ...
    num_archives = int(common_lib.get_command_stdout("cat {0}/info/num_archives".format(xvec_egs_dir)))

    if feat_dim != tmp_feat_dim:
        raise Exception('The feat_dim of am egs and xvec egs do not match')
    ...
    if (args.stage <= -3 and os.path.exists(args.dir+"/configs/init.config")
        ...
        train_lib.common.compute_preconditioning_matrix(
            args.dir, xvec_egs_dir, num_archives, run_opts,
    ...
    for iter in range(num_iters):
        ...
        if args.stage <= iter:
            ...
            train_lib.common.train_cvector_one_iteration(
                ...
                am_num_archives=am_num_archives, xvec_num_archives=num_archives,
                learning_rate=lrate,
    ...
    if args.stage <= num_iters:
        if args.do_final_combination:
            ...
            train_lib.common.combine_cvector_models(
