...
if [ $stage -le 5 ]; then
  ...
  # "am" part
  relu-batchnorm-layer name=tdnn1_am dim=650 input=Append(input@-2,input@-1,input@0,input@1,input@2)
  relu-batchnorm-layer name=tdnn2_am dim=650 input=Append(tdnn1_am@-1,tdnn1_am@0,tdnn1_am@1)
  relu-batchnorm-layer name=tdnn3_am dim=650 input=Append(tdnn2_am@-1,tdnn2_am@0,tdnn2_am@1)
  relu-batchnorm-layer name=tdnn4_am dim=650 input=Append(tdnn3_am@-3,tdnn3_am@0,tdnn3_am@3)
  relu-batchnorm-layer name=tdnn5_am dim=128 input=Append(tdnn4_am@-6,tdnn4_am@-3,tdnn4_am@0)

  relu-batchnorm-layer name=tdnn1 input=Append(input@-2,input@-1,input@0,input@1,input@2) dim=512
  relu-batchnorm-layer name=tdnn2 input=Append(tdnn1@-2,tdnn1@0,tdnn1@2) dim=512
  relu-batchnorm-layer name=tdnn3 input=Append(tdnn2@-3,tdnn2@0,tdnn2@3) dim=512
  relu-batchnorm-layer name=tdnn4 input=tdnn3 dim=512
  relu-batchnorm-layer name=tdnn5 input=Append(tdnn4, tdnn5_am) dim=1500
