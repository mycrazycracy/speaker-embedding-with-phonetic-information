...
if [ $stage -le 0 ]; then
  ...
  # am part
  relu-batchnorm-layer name=tdnn2_am dim=512 input=Append(tdnn1_share@-2,tdnn1_share@0,tdnn1_share@2)
  relu-batchnorm-layer name=tdnn3_am dim=512 input=Append(tdnn2_am@-3,tdnn2_am@0,tdnn2_am@3)
  ...
  # xvector part
  relu-batchnorm-layer name=tdnn2_xvec dim=512 input=Append(tdnn1_share@-2,tdnn1_share@0,tdnn1_share@2)
  relu-batchnorm-layer name=tdnn3_xvec dim=512 input=Append(tdnn2_xvec@-3,tdnn2_xvec@0,tdnn2_xvec@3)
