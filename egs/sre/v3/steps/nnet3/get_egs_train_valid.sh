...
if [ $# != 4 ]; then
  echo "Usage: $0 [opts] <train-dir> <valid-dir> <ali-dir> <egs-dir>"
...
for f in $train/feats.scp $valid/feats.scp $alidir/ali.1.gz $alidir/final.mdl $alidir/tree $extra_files; do
...
num_utts=$(cat $train/utt2spk | wc -l)
...
awk '{print $1}' $valid/utt2spk > $dir/valid_uttlist || exit 1;
awk '{print $1}' $train/utt2spk | utils/shuffle_list.pl | head -$num_utts_subset > $dir/train_subset_uttlist || exit 1;
...
sdata=$train/split$nj
utils/split_data.sh $train $nj

svalid=$valid/split$nj
utils/split_data.sh $valid $nj

## Set up features.
echo "$0: feature type is raw"

feats="ark,s,cs:apply-cmvn $cmvn_opts --utt2spk=ark:$sdata/JOB/utt2spk scp:$sdata/JOB/cmvn.scp scp:$sdata/JOB/feats.scp ark:- |"
valid_feats="ark,s,cs:apply-cmvn $cmvn_opts --utt2spk=ark:$valid/utt2spk scp:$valid/cmvn.scp scp:$valid/feats.scp ark:- |"
train_subset_feats="ark,s,cs:utils/filter_scp.pl $dir/train_subset_uttlist $train/feats.scp | apply-cmvn $cmvn_opts --utt2spk=ark:$train/utt2spk scp:$train/cmvn.scp scp:- ark:- |"
echo $cmvn_opts >$dir/cmvn_opts # caution: the top-level nnet training script should copy this to its own dir now.

if [ -f $dir/trans.scp ]; then
  echo "Add transform..."
  feats="$feats transform-feats --utt2spk=ark:$sdata/JOB/utt2spk scp:$dir/trans.scp ark:- ark:- |"
  valid_feats="$valid_feats transform-feats --utt2spk=ark:$valid/utt2spk scp:$dir/trans.scp ark:- ark:- |"
  train_subset_feats="$train_subset_feats transform-feats --utt2spk=ark:$train/utt2spk scp:$dir/trans.scp ark:- ark:- |"
fi
...
if [ $stage -le 1 ]; then
  ...
  num_frames=$(steps/nnet2/get_num_frames.sh $train)
