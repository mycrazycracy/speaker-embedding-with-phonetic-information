...
if [ $stage -le 0 ]; then
  ...
  relu-batchnorm-layer name=tdnn3_share dim=512 input=Append(tdnn2_share@-3,tdnn2_share@0,tdnn2_share@3)

  # am part
  relu-batchnorm-layer name=tdnn4_am dim=512 input=tdnn3_share
  ...
  # xvector part
  relu-batchnorm-layer name=tdnn4_xvec dim=512 input=tdnn3_share
