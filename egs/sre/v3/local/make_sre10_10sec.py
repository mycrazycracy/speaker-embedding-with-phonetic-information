...
if __name__ == '__main__':
    if len(sys.argv) != 3:
        print("{0}: sre10_list_dir 10sec_output_dir".format(sys.argv[0]))
        quit()
    ...
    trial_wav_map = {}
    org_trials = sre10_list_dir + "/trials/10sec-10sec.ndx"
    ...
    trial_key = sre10_list_dir + "/keys/10sec-10sec.trialkey.csv"
    ...
    sec_train = sre10_list_dir + "/train/10sec.trn"
    with open(sec_train, "r") as f:
        for line in f.readlines():
