...
#   # The following setup seems to perform worse 
#   # try to be consistent with xvector sharing setup
#   cat <<EOF > $dir/configs/network.xconfig
#     input dim=$feat_dim name=input
#     relu-batchnorm-layer name=tdnn1 dim=512 input=Append(-2,-1,0,1,2)
#     relu-batchnorm-layer name=tdnn2 dim=512 input=Append(-2,0,2)
...
#     relu-batchnorm-layer name=tdnn7 dim=128
#     output-layer name=output dim=$num_targets max-change=1.5
# EOF
